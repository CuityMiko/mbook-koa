...
Page({
  data: {
    ...
    preChapter: { num: 0, title: '', content: '', isok: false, msg: '获取上一章内容失败' },
    nextChapter: { num: 0, title: '', content: '', isok: false, msg: '获取下一章内容失败' },
    currentSectionNum: 1,
    bindTopValue: 0,
    newestSectionNum: 1,
    allSliderValue: {
